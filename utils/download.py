...
def download_celeb_a(dirpath):
    data_dir = 'celebA'
    img_dir = 'images'
    celeb_dir = os.path.join(dirpath, data_dir)
    if os.path.exists(os.path.join(celeb_dir, img_dir)):
        ...
        with zipfile.ZipFile(save_path) as zf:
            ...
            zf.extractall(celeb_dir)
        os.remove(save_path)
        os.rename(
            os.path.join(celeb_dir, zip_dir),
            os.path.join(celeb_dir, img_dir))
    add_splits(celeb_dir)
...
def add_splits(base_path):
    ...
    train_dir = os.path.join(base_path, 'splits', 'train')
    valid_dir = os.path.join(base_path, 'splits', 'valid')
    test_dir = os.path.join(base_path, 'splits', 'test')
